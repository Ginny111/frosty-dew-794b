...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/frosty-dew-794b)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/frosty-dew-794b
```

A live public deployment of this template is available at [https://frosty-dew-794b.templates.workers.dev](https://frosty-dew-794b.templates.workers.dev)
